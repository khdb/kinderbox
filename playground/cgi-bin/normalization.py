...
def remove_latin(str_input):
    try:
        #str_iso = str_input.encode("ISO-8859-1", "ignore")
        str_utf8 = str_input.decode("utf-8", "ignore")

        #str_iso = unicode(str_input, "ISO-8859-1", errors="ignore")
        #str_utf8 = unicode(str_iso, "UTF-8", errors="ignore")
        #print "str_iso: %s" %str_iso
        print "str_utf8: %s" %str_utf8
        char_list = []
        for c in str_utf8:
            dc = ord(c)
